...
export const DocumentSelectionModal: React.FC<DocumentSelectionModalProps> = ({
  ...
  const handleGoogleSheetsUpload = () => {
    showToast(t('documentSelection.googleSheetsUnderDevelopment'), 'info')
  }

  const handleDataSourcesTab = () => {
    showToast(t('documentSelection.dataSourcesUnderDevelopment'), 'info')
  }

  const handleEnrichmentsTab = () => {
    showToast(t('documentSelection.enrichmentsUnderDevelopment'), 'info')
  }
      ...
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col shadow-lg border border-gray-200">
        ...
        <div className="border-b border-gray-200 flex-shrink-0">
          <nav className="flex space-x-8 px-6">
            ...
            <button 
              onClick={handleDataSourcesTab}
              className="py-4 px-2 text-gray-500 hover:text-gray-700 transition-colors"
            >
              {t('documentSelection.dataSources')}
            </button>
            <button 
              onClick={handleEnrichmentsTab}
              className="py-4 px-2 text-gray-500 hover:text-gray-700 transition-colors"
            >
