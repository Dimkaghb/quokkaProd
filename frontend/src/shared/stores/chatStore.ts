      ...
      initializeChat: () => {
        ...
        if (state.messages.length === 0) {
          const welcomeMessage: Message = {
            id: 'welcome',
            type: 'agent',
            content: '👋 Привет! Добро пожаловать в QuokkaAI! Здесь ты можешь задавать вопросы и создавать кастомные визуализации по файлам, которые ты выбрал.\n\n📊 Ты можешь запрашивать визуализации, анализы и затем настраивать их через чат. Убедись, что ты загрузил подходящие данные для своих запросов, например, статистические данные для графиков.\n\n🇬🇧 You can ask for visualizations, analyses and then customize them with chat. Make sure you uploaded suitable data for your queries, for example statistical data for charts.',
            timestamp: new Date(),
            status: 'sent'
          }
